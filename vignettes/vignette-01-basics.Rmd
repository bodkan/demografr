...
write.table(observed_diversity, file = system.file("examples/basics_diversity.tsv", package = "demografr"),
            sep = "\t", row.names = FALSE, quote = FALSE)
write.table(observed_divergence, file = system.file("examples/basics_divergence.tsv", package = "demografr"),
            sep = "\t", row.names = FALSE, quote = FALSE)
write.table(observed_f4, file = system.file("examples/basics_f4.tsv", package = "demografr"),
            sep = "\t", row.names = FALSE, quote = FALSE)
```
...
```{r}
model <- simulate_model(model, priors, sequence_length = 100, recombination_rate = 0)
```
...
saveRDS(tdelta, system.file("examples/basics_tdelta.rds", package = "demografr"))
saveRDS(ncores, system.file("examples/basics_ncores.rds", package = "demografr"))
```

```{r, echo=FALSE, eval=file.exists(abc_path)}
tdelta <- readRDS(system.file("examples/basics_tdelta.rds", package = "demografr"))
ncores <- readRDS(system.file("examples/basics_ncores.rds", package = "demografr"))
```
...
```{r, eval=!file.exists(system.file("examples/basics_predictions.rds", package = "demografr"))}
...
```{r, eval=!file.exists(system.file("examples/basics_predictions.rds", package = "demografr")), echo=FALSE}
saveRDS(predictions, file = system.file("examples/basics_predictions.rds"))
```

```{r, eval=file.exists(system.file("examples/basics_predictions.rds", package = "demografr")), echo=FALSE}
predictions <- readRDS(system.file("examples/basics_predictions.rds", package = "demografr"))
```
