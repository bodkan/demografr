...
```{r, echo=FALSE}
ts <- demografr::simulate_ts(model, individual_priors, sequence_length = 1)
```
...
```{r, echo=FALSE}
ts <- demografr::simulate_ts(model, templated_priors, sequence_length = 1)
```
