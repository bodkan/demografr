...
# on machine #1
simulate_grid(model, grid, functions, replicates = 2, sequence_length = 100000, recombination_rate = 1e-8, file = run1_file)

# on machine #2
simulate_grid(model, grid, functions, replicates = 2, sequence_length = 100000, recombination_rate = 1e-80, file = run2_file)

# on machine #3
simulate_grid(model, grid, functions, replicates = 2, sequence_length = 100000, recombination_rate = 1e-80, file = run3_file)

# on machine #4
simulate_grid(model, grid, functions, replicates = 2, sequence_length = 100000, recombination_rate = 1e-80, file = run4_file)

# on machine #5
simulate_grid(model, grid, functions, replicates = 2, sequence_length = 100000, recombination_rate = 1e-80, file = run5_file)
```
