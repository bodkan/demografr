...
```{r}
data <- combine_grid(run1_file, run2_file, run3_file)
...
```{r}
combined1 <- combine_grid(run1_file, run2_file, run3_file)
combined2 <- combine_grid(list(run1_file, run2_file, run3_file))
```
...
combined3 <- combine_grid(run1, run2, run3)
combined4 <- combine_grid(list(run1, run2, run3))
```
