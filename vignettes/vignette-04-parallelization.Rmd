...
```{r}
grid <- tidyr::crossing(
  Ne_p1 = c(100, 1000, 10000),
  Ne_p2 = c(100, 1000, 10000)
)
...
```{r}
ts <- simulate_ts(model, params = list(Ne_p1 = 100, Ne_p2 = 10000), mutation_rate = 1e-8)
...
```{r}
data1 <- combine_grid(run1_file, run2_file, run3_file, run4_file, run5_file)
data2 <- combine_grid(list(run1_file, run2_file, run3_file, run4_file, run5_file))
```
...
```{r}
data1 <- simulate_grid(model, grid, functions, replicates = 4, sequence_length = 100000, recombination_rate = 0)
data2 <- simulate_grid(model, grid, functions, replicates = 4, sequence_length = 100000, recombination_rate = 0)
data3 <- simulate_grid(model, grid, functions, replicates = 4, sequence_length = 100000, recombination_rate = 0)
data4 <- simulate_grid(model, grid, functions, replicates = 4, sequence_length = 100000, recombination_rate = 0)
data5 <- simulate_grid(model, grid, functions, replicates = 4, sequence_length = 100000, recombination_rate = 0)
```

```{r}
data3 <- combine_grid(data1, data2, data3, data4, data5)
data4 <- combine_grid(data1, data2, data3, data4, data5)
```
