...
```{r, echo=FALSE, eval=!on_windows && !file.exists(path_observed) && Sys.getenv("RERUN") == "TRUE"}}
...
```{r, eval=!on_windows && !file.exists(abc_path1) && Sys.getenv("RERUN") == "TRUE"}}
library(future)
...
```{r, echo=FALSE, eval=!on_windows && !file.exists(abc_path1) && Sys.getenv("RERUN") == "TRUE"}}
