...
abc_exists <- all(sapply(list(abc_path1, abc_path2, abc_path3, abc_path4), file.exists))
...
knitr::opts_chunk$set(
  ...
  fig.height = 5,
  dpi = 60,
  eval = slendr_present && abc_exists
)
```
...
[here](https://bodkan.net/demografr/articles/vignette-01-basics.html) and
[here](https://bodkan.net/demografr/articles/vignette-06-diagnostics.html)).
