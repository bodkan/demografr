...
path_observed <- here::here("examples/custom_diversity.rds")
abc_path1 <- here::here("examples/custom_abc1.rds")
abc_path2 <- here::here("examples/custom_abc2.rds")
abc_path3 <- here::here("examples/custom_abc3.rds")
abc_path4 <- here::here("examples/custom_abc4.rds")
```
...
saveRDS(tdelta, here::here("examples/custom_tdelta1.rds"))
saveRDS(ncores, here::here("examples/custom_ncores1.rds"))
```

```{r, echo=FALSE, eval=file.exists(abc_path1)}
tdelta <- readRDS(here::here("examples/custom_tdelta1.rds"))
ncores <- readRDS(here::here("examples/custom_ncores1.rds"))
```
