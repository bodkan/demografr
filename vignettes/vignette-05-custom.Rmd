...
path_observed <- here::here("inst/examples/custom_diversity.rds")
abc_path1 <- here::here("inst/examples/custom_abc1.rds")
abc_path2 <- here::here("inst/examples/custom_abc2.rds")
abc_path3 <- here::here("inst/examples/custom_abc3.rds")
abc_path4 <- here::here("inst/examples/custom_abc4.rds")
...
saveRDS(tdelta, here::here("inst/examples/custom_tdelta3.rds"))
saveRDS(ncores, here::here("inst/examples/custom_ncores3.rds"))
```

```{r, echo=FALSE, eval=file.exists(abc_path3)}
tdelta <- readRDS(here::here("inst/examples/custom_tdelta3.rds"))
ncores <- readRDS(here::here("inst/examples/custom_ncores3.rds"))
```
...
py_run_string(r"(
def homebrew_diversity_function(ts):
    diffs = []
...
functions <- list(diversity = py$homebrew_diversity_function)
```
...
saveRDS(tdelta, here::here("inst/examples/custom_tdelta4.rds"))
saveRDS(ncores, here::here("inst/examples/custom_ncores4.rds"))
```

```{r, echo=FALSE, eval=file.exists(abc_path4)}
tdelta <- readRDS(here::here("inst/examples/custom_tdelta4.rds"))
ncores <- readRDS(here::here("inst/examples/custom_ncores4.rds"))
```
