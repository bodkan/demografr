...
abc_path1 <- system.file("examples/custom_abc1.rds", package = "demografr")
abc_path2 <- system.file("examples/custom_abc2.rds", package = "demografr")
abc_path3 <- system.file("examples/custom_abc3.rds", package = "demografr")
abc_path4 <- system.file("examples/custom_abc4.rds", package = "demografr")
...
saveRDS(tdelta, system.file("examples/custom_tdelta1.rds", package = "demografr"))
saveRDS(ncores, system.file("examples/custom_ncores1.rds", package = "demografr"))
```

```{r, echo=FALSE, eval=file.exists(abc_path1)}
tdelta <- readRDS(system.file("examples/custom_tdelta1.rds", package = "demografr"))
ncores <- readRDS(system.file("examples/custom_ncores1.rds", package = "demografr"))
```
...
compute_diversity_vcf <- function(vcf) {
  ...
  program <- "/project/inst/examples/vcfpi"
  tsv <- tempfile()
...
saveRDS(tdelta, system.file("examples/custom_tdelta2.rds", package = "demografr"))
saveRDS(ncores, system.file("examples/custom_ncores2.rds", package = "demografr"))
```

```{r, echo=FALSE, eval=file.exists(abc_path2)}
tdelta <- readRDS(system.file("examples/custom_tdelta2.rds", package = "demografr"))
ncores <- readRDS(system.file("examples/custom_ncores2.rds", package = "demografr"))
```
...
saveRDS(tdelta, system.file("examples/custom_tdelta3.rds", package = "demografr"))
saveRDS(ncores, system.file("examples/custom_ncores3.rds", package = "demografr"))
```

```{r, echo=FALSE, eval=file.exists(abc_path3)}
tdelta <- readRDS(system.file("examples/custom_tdelta3.rds", package = "demografr"))
ncores <- readRDS(system.file("examples/custom_ncores3.rds", package = "demografr"))
```
...
saveRDS(tdelta, system.file("examples/custom_tdelta4.rds", package = "demografr"))
saveRDS(ncores, system.file("examples/custom_ncores4.rds", package = "demografr"))
```

```{r, echo=FALSE, eval=file.exists(abc_path4)}
tdelta <- readRDS(system.file("examples/custom_tdelta4.rds", package = "demografr"))
ncores <- readRDS(system.file("examples/custom_ncores4.rds", package = "demografr"))
```
