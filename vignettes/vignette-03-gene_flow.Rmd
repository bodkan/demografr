...
gf <- list(
  gene_flow(from = p2, to = p4, start = 9000, end = 9501, rate = 0.25),
  gene_flow(from = p2, to = p1, start = 7000, end = 7501, rate = 0.10)
)
...
```{r, echo=FALSE}
saveRDS(data, "inst/extdata/vignette_01_sims_gene_flow.rds")
