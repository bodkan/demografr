...
Again, we will skip the simulations and inference, which we would normally perform with something like this:
...
Having convinced ourselves that the ABC model components are correctly configured, we would proceed with inference:
