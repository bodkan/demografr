...
```{r, eval=FALSE}
simulate_abc(model1, priors, functions, observed, iterations = 10,
...
```{r, eval=FALSE}
simulate_abc(model2, priors, functions, observed, iterations = 10,
             sequence_length = 1e5, recombination_rate = 1e-8)
```

```{r}
a=simulate_abc(model2, priors, functions, observed, iterations = 10,
             sequence_length = 1e5, recombination_rate = 1e-8)
b=simulate_abc(model2, priors, functions, observed, iterations = 10,
             sequence_length = 1e5, recombination_rate = 1e-8)
c=simulate_abc(model2, priors, functions, observed, iterations = 10,
             sequence_length = 1e5, recombination_rate = 1e-8)
```
...
```{r}
custom_model <- function(size_A, size_B, size_C, size_D,
                         split_AB, split_BC, split_CD) {
...
test_model <- custom_model(
  size_popA = 1123, size_popB = 4321, size_popC = 42, size_popD = 2000,
...
```{r, eval=FALSE}
simulate_abc(generate_model, custom_priors, functions, observed, iterations = 100,
             sequence_length = 1e5, recombination_rate = 1e-8)
```
