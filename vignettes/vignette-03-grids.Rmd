...
knitr::opts_chunk$set(
  ...
  fig.height = 5,
  dpi = 60,
  eval = !file.exists(data_path) && slendr_present && Sys.getenv("RUNNER_OS") == "" # don't rerun on CRAN or GHA (no rds)
)
```
...
```{r, eval=!file.exists(data_path) && Sys.getenv("RERUN") == "TRUE"}
...
```{r, echo=FALSE, eval=Sys.getenv("RERUN") == "TRUE"}
