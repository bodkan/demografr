...
saveRDS(tdelta, system.file("examples/grid_tdelta.rds", package = "demografr"))
saveRDS(ncores, system.file("examples/grid_ncores.rds", package = "demografr"))
```

```{r, echo=FALSE, eval=file.exists(data_path)}
tdelta <- readRDS(system.file("examples/grid_tdelta.rds", package = "demografr"))
ncores <- readRDS(system.file("examples/grid_ncores.rds", package = "demografr"))
```
