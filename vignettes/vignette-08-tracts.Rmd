...
```{r}
data <- simulate_abc(model, priors, functions, observed, iterations = 1000,
                     sequence_length = 200e6, recombination_rate = 1e-8)
...
```{r}
plot_posterior(abc, param = "admixture_time")
```

```{r}
plot_posterior(abc, param = "admixture_rate")
```
