...
```{r}
predictions <- predict(abc_bins, samples = 500)
predictions <- predict(abc_f4, samples = 500)
predictions <- predict(abc_f4ratio, samples = 500)
predictions <- predict(abc_binsf4, samples = 500)
predictions <- predict(abc_binsf4ratio, samples = 500)
predictions <- predict(abc_all, samples = 500)
```
