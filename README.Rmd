...
that the interface might change on a rather short notice to accommodate features
for estimating parameters of much more complex models. You can follow _demografr_
updates and bugfixes by checking out the
[changelog](https://github.com/bodkan/demografr/blob/main/NEWS.md) from time
to time.
