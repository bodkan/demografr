...
```{r, eval=!file.exists(here::here("inst/examples/data.rds"))}
library(demografr)
library(slendr)
...
abc <- perform_abc(data, tol = 0.03, method = "neuralnet")
```

```{r, echo=FALSE, eval=!file.exists(here::here("inst/examples/data.rds"))}
saveRDS(data, here::here("inst/examples/data.rds"))
```

```{r, echo=FALSE, eval=file.exists(here::here("inst/examples/data.rds")), warning=FALSE, message=FALSE, results="hide"}
data <- readRDS(system.file("examples/data.rds", package = "demografr"))
abc <- perform_abc(data, tolerance = 0.03, method = "neuralnet")
```
